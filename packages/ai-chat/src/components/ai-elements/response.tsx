...
// Note: harden-react-markdown has bundling issues, using ReactMarkdown directly
...
// Using ReactMarkdown directly due to bundling issues with hardenReactMarkdown
const HardenedMarkdown = ReactMarkdown;

...
export class ClaudeAgent extends BaseAgent {
  ...
  private escapePrompt(prompt: string): string {
    // Handle undefined/null prompts
    if (prompt === undefined || prompt === null) {
      console.warn('[ClaudeAgent] escapePrompt called with undefined/null prompt, returning empty string');
      return '';
    }
    
    // Ensure we have a string
    if (typeof prompt !== 'string') {
      console.warn('[ClaudeAgent] escapePrompt called with non-string prompt:', typeof prompt, prompt);

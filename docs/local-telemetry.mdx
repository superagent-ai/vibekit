...
```typescript
{
  ...
  serviceVersion: '0.0.1',             // or from package.json version
  database: {
...
The easiest way to explore your telemetry data is through the built-in dashboard:
...
- **Session analysis** with detailed timelines
- **Performance metrics** and charts
- **Error tracking** and debugging tools

See the [Dashboard guide](/dashboard) for detailed information.

## Next Steps

Once you have local telemetry set up:

1. **Explore the Dashboard**: Start with `vibekit dashboard` to visualize your data
...
- [Dashboard](/dashboard) - Visual monitoring and management interface
- [OpenTelemetry Integration](/open-telemetry) - Export to external systems
- [CLI Commands](/cli/commands/telemetry) - Command reference
- [Database Management](/cli/commands/database) - Database operations
